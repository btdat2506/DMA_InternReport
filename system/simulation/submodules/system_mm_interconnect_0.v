...
module system_mm_interconnect_0 (
	...
	wire  [18:0] dma_controller_avalon_slave_0_agent_m0_address;                                     // DMA_Controller_avalon_slave_0_agent:m0_address -> DMA_Controller_avalon_slave_0_translator:uav_address
	...
	wire  [95:0] dma_controller_avalon_slave_0_agent_rf_source_data;                                 // DMA_Controller_avalon_slave_0_agent:rf_source_data -> DMA_Controller_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [95:0] dma_controller_avalon_slave_0_agent_rsp_fifo_out_data;                              // DMA_Controller_avalon_slave_0_agent_rsp_fifo:out_data -> DMA_Controller_avalon_slave_0_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> DMA_Controller_avalon_slave_0_agent:cp_valid
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> DMA_Controller_avalon_slave_0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // DMA_Controller_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> DMA_Controller_avalon_slave_0_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> DMA_Controller_avalon_slave_0_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> DMA_Controller_avalon_slave_0_agent:cp_endofpacket
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> onchip_memory2_1_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // onchip_memory2_1_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> onchip_memory2_1_s1_agent:cp_channel
	...
	wire         dma_controller_avalon_slave_0_agent_rp_valid;                                       // DMA_Controller_avalon_slave_0_agent:rp_valid -> router_003:sink_valid
	wire  [94:0] dma_controller_avalon_slave_0_agent_rp_data;                                        // DMA_Controller_avalon_slave_0_agent:rp_data -> router_003:sink_data
	wire         dma_controller_avalon_slave_0_agent_rp_ready;                                       // router_003:sink_ready -> DMA_Controller_avalon_slave_0_agent:rp_ready
	wire         dma_controller_avalon_slave_0_agent_rp_startofpacket;                               // DMA_Controller_avalon_slave_0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         dma_controller_avalon_slave_0_agent_rp_endofpacket;                                 // DMA_Controller_avalon_slave_0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [94:0] onchip_memory2_1_s1_agent_rp_data;                                                  // onchip_memory2_1_s1_agent:rp_data -> router_006:sink_data
	...
	wire         dma_controller_avalon_slave_0_agent_rdata_fifo_src_valid;                           // DMA_Controller_avalon_slave_0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] dma_controller_avalon_slave_0_agent_rdata_fifo_src_data;                            // DMA_Controller_avalon_slave_0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         dma_controller_avalon_slave_0_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_001:in_0_ready -> DMA_Controller_avalon_slave_0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> DMA_Controller_avalon_slave_0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> DMA_Controller_avalon_slave_0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // DMA_Controller_avalon_slave_0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> DMA_Controller_avalon_slave_0_agent:rdata_fifo_sink_error
