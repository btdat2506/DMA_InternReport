...
# Wed Apr 09 11:26:19 ICT 2025
# DO NOT MODIFY


# 
# DMA_Controller "DMA_Controller" v1.0
#  2025.04.09.11:26:19
# 
# 
...
set_module_property NAME DMA_Controller
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME DMA_Controller
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL DMAController
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file DMAController.v VERILOG PATH DMAC/DMAController.v TOP_LEVEL_FILE
add_fileset_file CONTROL_SLAVE.v VERILOG PATH DMAC/CONTROL_SLAVE.v
add_fileset_file READ_MASTER.v VERILOG PATH DMAC/READ_MASTER.v
add_fileset_file WRITE_MASTER.v VERILOG PATH DMAC/WRITE_MASTER.v
add_fileset_file FIFO_IP.qip OTHER PATH FIFO_IP.qip
add_fileset_file FIFO_IP.v VERILOG PATH FIFO_IP.v

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL DMAController
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file CONTROL_SLAVE.v VERILOG PATH DMAC/CONTROL_SLAVE.v
add_fileset_file DMAController.v VERILOG PATH DMAC/DMAController.v
add_fileset_file READ_MASTER.v VERILOG PATH DMAC/READ_MASTER.v
add_fileset_file WRITE_MASTER.v VERILOG PATH DMAC/WRITE_MASTER.v
add_fileset_file FIFO_IP.qip OTHER PATH FIFO_IP.qip
add_fileset_file FIFO_IP.v VERILOG PATH FIFO_IP.v
...
add_interface_port avalon_master oRM_read read Output 1
add_interface_port avalon_master oRM_readaddress address Output 32
add_interface_port avalon_master iRM_readdatavalid readdatavalid Input 1
add_interface_port avalon_master iRM_waitrequest waitrequest Input 1
add_interface_port avalon_master iRM_readdata readdata Input 32
...
add_interface_port avalon_master_1 iWM_waitrequest waitrequest Input 1
add_interface_port avalon_master_1 oWM_writedata writedata Output 32
add_interface_port avalon_master_1 oWM_writeaddress address Output 32
add_interface_port avalon_master_1 oWM_write write Output 1
add_interface_port avalon_master_1 oWM_byteenable byteenable Output 4
